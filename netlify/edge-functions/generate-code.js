...
// Unambiguous charset — no 0/O, 1/I/L confusion when read aloud or typed on a phone
...
export default async (req) => {
  ...
  const adminKey = Netlify.env.get("STYLESWIFT_ADMIN_KEY");
  ...
  // Guarantee uniqueness against any existing code
  let code;
  do {
    code = generateCode();
